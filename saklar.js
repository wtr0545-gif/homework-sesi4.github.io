function saklar() {
    ...
    let toggle4 = document.getElementById("AcceptConditions4");
    let toggle5 = document.getElementById("AcceptConditions5");
    let toggle6 = document.getElementById("AcceptConditions6");
    let toggle7 = document.getElementById("AcceptConditions7");
    let toggle8 = document.getElementById("AcceptConditions8");
    let toggle9 = document.getElementById("AcceptConditions9");
    let toggle10 = document.getElementById("AcceptConditions10");
